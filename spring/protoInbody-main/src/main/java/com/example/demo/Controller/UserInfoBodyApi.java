...
public class UserInfoBodyApi {
        ...
        @Operation(summary = "신체 정보 기록", description = "사용자의 신체 정보를 기록하고 저장된 정보를 반환합니다.", responses = {
                        @ApiResponse(responseCode = "200", description = "신체 정보 기록 성공", content = @Content(schema = @Schema(implementation = UserBodyInfoDTO.class))),
        ...
        @Operation(summary = "최근 신체 정보 기록 조회", description = "사용자 ID를 기반으로 최근 신체 정보 기록들을 조회합니다.", responses = {
                        @ApiResponse(responseCode = "200", description = "최근 신체 정보 기록 조회 성공", content = @Content(schema = @Schema(implementation = UserBodyInfoDTO.class))),
